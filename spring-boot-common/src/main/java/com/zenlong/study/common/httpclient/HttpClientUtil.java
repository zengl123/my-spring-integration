package com.zenlong.study.common.httpclient;
...
public enum HttpClientUtil {
    ...
    DELETE {
        @Override
        public Result formData(String uri, Map<String, String> headers, Map<String, String> body, Charset charset) throws Exception {
            return delete(uri, headers, charset);
        }
    ...
    static Result delete(String uri, Map<String, String> headers,
     ...
     */
    static HttpRequestBase request(String uri, Map<String, String> headers, METHOD method) {
     ...
     */
    static HttpEntityEnclosingRequestBase request(String uri, Map<String, String> headers, Map<String, String> body, String bodyAsString, CONTENT_TYPE contentType, METHOD method, Charset charset) throws Exception {
     ...
     * @return HttpEntity
     */
    static HttpEntity partEntity(Map<String, String> body, String bodyAsString, CONTENT_TYPE contentType, Charset charset) throws NoSuchMethodException {
