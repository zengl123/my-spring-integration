...
public class RsaUtil {
    ...
    public static String decrypt(String cipherText,String seed) throws Exception {
        ...
        String decodedStr = RsaUtil.decryptByPrivateKey(cipherText, privateKey);
        return decodedStr;
    }
    ...
    public static String encrypt(String plainText,String seed) throws Exception {
        ...
        String decodedStr = RsaUtil.encryptByPublicKey(plainText, publicKey);
        return decodedStr;
    }
}
